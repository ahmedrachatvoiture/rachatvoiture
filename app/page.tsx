...
Message envoyé depuis le site web AUTO EXPERT`
  ...
  return (
    <div className="min-h-screen bg-white overflow-x-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div className="text-white order-2 lg:order-1">
              ...
              <p className="text-base sm:text-lg lg:text-xl mb-6 sm:mb-8 leading-relaxed">
                Nous vous rachetons votre véhicule en l'état : toutes marques, tous kilométrages, tous types, en bon
                état, en panne, accidenté, hors d'usage, roulant ou non, avec ou sans contrôle technique
              </p>
              <Button
                onClick={scrollToForm}
            ...
            <Card
              id="contact-form"
              className="bg-white p-4 sm:p-6 shadow-xl border-t-4 border-emerald-500 transition-all duration-300 order-1 lg:order-2 w-full max-w-lg mx-auto lg:max-w-none"
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                  <select
                    ...
                    onChange={handleInputChange}
                    className="w-full p-2 border border-gray-300 rounded-md focus:border-emerald-500 focus:ring-emerald-500 text-sm sm:text-base"
                    required
                  >
      ...
      <section id="vehicules" className="py-12 sm:py-16 bg-emerald-50">
      ...
      <section className="py-0">
        <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[400px] sm:min-h-[600px]">
          <div className="bg-emerald-50 flex items-center p-6 sm:p-8 lg:p-12 order-2 lg:order-1">
            <div className="max-w-lg mx-auto lg:mx-0">
              ...
              <div className="space-y-3 sm:space-y-4 mb-6 sm:mb-8">
                <div className="flex items-start space-x-3">
                  <span className="bg-emerald-600 text-white font-bold w-6 h-6 rounded flex items-center justify-center text-sm flex-shrink-0 mt-0.5">
                    1
                  </span>
              ...
              <Button
                onClick={scrollToForm}
                className="bg-amber-500 hover:bg-amber-600 text-white text-sm sm:text-base lg:text-lg px-6 sm:px-8 py-2 sm:py-3 font-semibold w-full sm:w-auto"
              >
                ESTIMER MA VOITURE
              </Button>
            </div>
      ...
      <section className="py-0">
        <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[400px] sm:min-h-[600px]">
          ...
          <div className="bg-emerald-50 flex items-center p-6 sm:p-8 lg:p-12 order-2">
            <div className="max-w-lg mx-auto lg:mx-0">
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-4 sm:mb-6 text-gray-800">
                Rachat de voiture
              </h2>
              ...
              <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4">
                <Button className="bg-emerald-600 hover:bg-emerald-700 text-white text-sm sm:text-base lg:text-lg px-4 sm:px-6 py-2 sm:py-3 font-semibold">
                  📞 0477 03 06 90
                </Button>
                <Button
                  onClick={scrollToForm}
                  className="bg-amber-500 hover:bg-amber-600 text-white text-sm sm:text-base lg:text-lg px-4 sm:px-6 py-2 sm:py-3 font-semibold"
                >
                  ESTIMER MA VOITURE →
                </Button>
              </div>
      ...
      {/* Footer */}
      <footer className="bg-emerald-600 text-white py-8 sm:py-12">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            <div>
          ...
          <div className="border-t border-emerald-500 mt-6 sm:mt-8 pt-6 sm:pt-8 text-center text-sm sm:text-base text-emerald-100">
